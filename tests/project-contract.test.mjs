...
function projectWithSlug(slug) {
  return {
    ...
    assetBaseUrl: 'https://raw.githubusercontent.com/fixture-owner/numeric/main/.portfolio/',
    translations: {
      en: {
...
test('localized projects select requested content and fall back to English', () => {
  const project = {
    ...
    assetBaseUrl: 'https://raw.githubusercontent.com/fixture-owner/localized/main/.portfolio/',
    translations: {
      en: {
