...
const fixturePath = path.join(projectDirectory, 'fixtures', 'github-projects.json')
...
writeFileSync(path.join(cacheDirectory, 'github-projects.json'), fixtureContents, 'utf8')
