...
const assetBaseUrl = 'https://raw.githubusercontent.com/fixture-owner/project/main/.portfolio/'
...
test('project images resolve only relative paths against their repository', () => {
  ...
  assert.equal(resolveProjectImageSource('https://example.com/dashboard.webp', assetBaseUrl), '')
  assert.equal(resolveProjectImageSource('//example.com/dashboard.webp', assetBaseUrl), '')
})
