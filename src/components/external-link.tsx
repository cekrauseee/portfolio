...
export const actionClassName = `${linkFocusClassName} w-fit bg-black px-4 py-2 text-sm text-white no-underline hover:bg-black/80 dark:bg-white dark:text-black dark:hover:bg-white/80`;
