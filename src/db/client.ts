...
export function resolveDatabaseUrl(environment: DatabaseEnvironment = env): string | undefined {
...
export function database(environment: DatabaseEnvironment = env): Database | undefined {
