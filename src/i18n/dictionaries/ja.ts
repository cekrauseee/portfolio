...
export const ja: Dictionary = {
  ...
  home: {
    ...
    bio: {
      intro:
        "リスボンを拠点に、人とエージェントのためのプロダクト、インターフェース、ツールを丁寧につくるソフトウェアエンジニアです。",
      process:
        "人が何を必要としているのかを理解し、それをどうソフトウェアにするか考えるのが好きです。アイデアについて話し、前提を問い、アーキテクチャを考え、コードを書くところまで一連の仕事を楽しんでいます。実際に使ったときの感覚にも気を配ります。",
      interests:
        "主にtypescriptとnode.jsを使っています。最近はaiエージェントとオーケストレーションを探っています。エージェント同士がどう連携するか、役立つ文脈をどう保つか、どこまで可能性を広げられるかに興味があります。",
    },
    experience: {
      title: "経験",
      linkedin: "linkedinで経歴を見る",
      entries: {
        teamIt: {
          roleAndPeriod: "ソフトウェアエンジニア · 2026年2月–7月",
          paragraphs: {
            first:
              "r&dでaiとエージェントの実験に取り組みました。中心となったのは、コンサルタントを面接するマネージャー向けのデスクトップアシスタントです。r&dディレクターと要件を整理し、アーキテクチャからmicrosoft storeでの公開までアプリケーションを構築しました。",
            second:
              "会議中に質問を提案し、終了後には文字起こしやファイルを扱う手助けができました。退職前には、少人数のコンサルタントが実際の会議で利用していました。",
          },
        },
        clinia: {
          roleAndPeriod:
            "フルスタックインターン → ソフトウェアエンジニア · 2023年11月–2025年11月",
          paragraphs: {
            first:
              "エンジニアリングチームの4人目として参加し、最初の1年間はインターンでした。クリニックが患者との会話を管理し、日常業務を自動化するためのソフトウェアをつくっていました。",
            second:
              "プロダクト機能やビジュアルなワークフローに取り組み、プラットフォーム初のaiエージェントの初期モジュールを構築しました。プロダクトの成長に合わせて、サポート、安定性、バックエンドとaiアーキテクチャの変更にも携わりました。",
          },
        },
        killing: {
          roleAndPeriod: "itインターン · 2022年9月–2023年4月",
          paragraph:
            "塗料メーカーでitサポートを担当しながら、いくつかのアプリケーションもつくりました。営業担当者が顧客訪問のチェックリストを記入するためのアプリは本番運用され、もう一つは工場設備を監視するためのプロトタイプでした。",
        },
      },
    },
    contact: {
      title: "連絡する",
      description:
        "新しい仕事やフリーランスの相談を受け付けています。何か考えていることがあれば、ぜひ聞かせてください。",
      email: "メールを送る",
      roleFitDescription:
        "募集内容と、ここで紹介している自分の仕事を比較することもできます。",
      roleFit: "募集内容と自分の仕事を比較する",
    },
    guestbook: {
      title: "ゲストブック",
      description: "地球儀にメッセージを残したり、訪れた人を見たりできます。",
      visit: "ゲストブックを見る",
    },
  },
  fit: {
