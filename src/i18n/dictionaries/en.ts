...
export const en: Dictionary = {
  ...
  guestbook: {
    ...
    serviceUnavailable:
      "the guestbook is unavailable right now. try again in a moment.",
    submissionConflict: "unable to retry this message. send it again.",
    unableToSend: "unable to post this message. try again.",
    connectionError:
      "unable to post this message. check your connection and try again.",
  ...
  fit: {
    description:
      "paste the job description and i'll compare it with the work i've done.",
    form: {
      ...
      connectionError:
        "unable to compare this job. check your connection and try again.",
