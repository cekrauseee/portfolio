...
const seedMessages = [
  {
    name: 'Marta',
    message: 'passei por aqui enquanto tomava um café. gostei muito do cuidado com os detalhes.',
  },
  {
    name: 'Noah',
  ...
  {
    name: 'Caio',
    message: 'curti bastante a forma como os projetos contam o processo, não só o resultado.',
  },
  {
    name: 'Sofia',
    message: 'A small note from Lisbon. The guestbook fits the site beautifully.',
  },
  {
    name: '민준',
  ...
  {
    name: 'Theo',
    message: 'Found this through GitHub. The writing makes the work easy to understand.',
  },
  {
    name: 'Bia',
    message:
...
try {
  ...
  console.error('Unable to seed the guestbook. Check the local database and migrations.')
  process.exitCode = 1
} finally {
